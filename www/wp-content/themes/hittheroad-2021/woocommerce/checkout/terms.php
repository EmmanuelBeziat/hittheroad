	...
	<div class="woocommerce-terms-and-conditions-wrapper">
		...
		<?php if (wc_terms_and_conditions_checkbox_enabled()) : ?>
			<div class="validate-required">
				...
				<label class="form-check-label" for="terms"><?php wc_terms_and_conditions_checkbox_text(); ?> <span class="required" aria-label="<?php esc_attr_e('required', 'woocommerce'); ?>">*</span></label>
