		...
		<div class="form-card">
			...
			<form class="woocommerce-form woocommerce-form-login" method="post">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" name="username" id="username" autocomplete="username" value="<?= (!empty($_POST['username'])) ? esc_attr(wp_unslash($_POST['username'])) : ''; ?>"><?php // @codingStandardsIgnoreLine ?>
				</div>
				<div class="mb-3">
